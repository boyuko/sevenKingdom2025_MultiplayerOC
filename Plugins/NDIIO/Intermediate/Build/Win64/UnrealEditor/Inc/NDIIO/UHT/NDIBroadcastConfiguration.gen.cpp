...
// Begin ScriptStruct FNDIBroadcastConfiguration
...
const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FNDIBroadcastConfiguration_Statics::NewProp_FrameSize = { "FrameSize", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FNDIBroadcastConfiguration, FrameSize), Z_Construct_UScriptStruct_FIntPoint, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_FrameSize_MetaData), NewProp_FrameSize_MetaData) };
const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FNDIBroadcastConfiguration_Statics::NewProp_FrameRate = { "FrameRate", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FNDIBroadcastConfiguration, FrameRate), Z_Construct_UScriptStruct_FFrameRate, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_FrameRate_MetaData), NewProp_FrameRate_MetaData) };
...
const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FNDIBroadcastConfiguration_Statics::StructParams = {
...
UScriptStruct* Z_Construct_UScriptStruct_FNDIBroadcastConfiguration()
{
	...
	{
		UECodeGen_Private::ConstructUScriptStruct(Z_Registration_Info_UScriptStruct_NDIBroadcastConfiguration.InnerSingleton, Z_Construct_UScriptStruct_FNDIBroadcastConfiguration_Statics::StructParams);
	}
	return Z_Registration_Info_UScriptStruct_NDIBroadcastConfiguration.InnerSingleton;
}
// End ScriptStruct FNDIBroadcastConfiguration

// Begin Registration
struct Z_CompiledInDeferFile_FID_MultiplayerOC_Plugins_NDIIO_Source_Core_Public_Structures_NDIBroadcastConfiguration_h_Statics
{
	static constexpr FStructRegisterCompiledInInfo ScriptStructInfo[] = {
		{ FNDIBroadcastConfiguration::StaticStruct, Z_Construct_UScriptStruct_FNDIBroadcastConfiguration_Statics::NewStructOps, TEXT("NDIBroadcastConfiguration"), &Z_Registration_Info_UScriptStruct_NDIBroadcastConfiguration, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FNDIBroadcastConfiguration), 42070519U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_MultiplayerOC_Plugins_NDIIO_Source_Core_Public_Structures_NDIBroadcastConfiguration_h_6641461(TEXT("/Script/NDIIO"),
	nullptr, 0,
	Z_CompiledInDeferFile_FID_MultiplayerOC_Plugins_NDIIO_Source_Core_Public_Structures_NDIBroadcastConfiguration_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_MultiplayerOC_Plugins_NDIIO_Source_Core_Public_Structures_NDIBroadcastConfiguration_h_Statics::ScriptStructInfo),
	nullptr, 0);
// End Registration
