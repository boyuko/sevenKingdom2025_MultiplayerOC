...
const UECodeGen_Private::FEnumPropertyParams Z_Construct_UScriptStruct_FMCAppSettings_Statics::NewProp_BvhRotation = { "BvhRotation", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FMCAppSettings, BvhRotation), Z_Construct_UEnum_NeuronLiveLink_EMCBvhRotationOrder, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_BvhRotation_MetaData), NewProp_BvhRotation_MetaData) }; // 2690004195
...
const UECodeGen_Private::FEnumPropertyParams Z_Construct_UScriptStruct_FMCRenderSetting_Statics::NewProp_RotatingDir = { "RotatingDir", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FMCRenderSetting, RotatingDir), Z_Construct_UEnum_NeuronLiveLink_EMCRotatingDirection, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_RotatingDir_MetaData), NewProp_RotatingDir_MetaData) }; // 2580209811
...
struct Z_Construct_UClass_UMocapApp_Statics
{
	...
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		{ &Z_Construct_UFunction_UMocapApp_Connect, "Connect" }, // 22541773
		{ &Z_Construct_UFunction_UMocapApp_Disconnect, "Disconnect" }, // 748949372
		{ &Z_Construct_UFunction_UMocapApp_GetAllAvatarNames, "GetAllAvatarNames" }, // 3448912563
		{ &Z_Construct_UFunction_UMocapApp_GetAllRigidBodyNames, "GetAllRigidBodyNames" }, // 3154670721
		{ &Z_Construct_UFunction_UMocapApp_GetAllTrackerNames, "GetAllTrackerNames" }, // 3760400737
		{ &Z_Construct_UFunction_UMocapApp_GetAvatarData, "GetAvatarData" }, // 4005719695
		{ &Z_Construct_UFunction_UMocapApp_GetAvatarStaticData, "GetAvatarStaticData" }, // 3887316159
		{ &Z_Construct_UFunction_UMocapApp_GetConnectionString, "GetConnectionString" }, // 2010906003
		{ &Z_Construct_UFunction_UMocapApp_GetIsConnecting, "GetIsConnecting" }, // 1179584913
		...
		{ &Z_Construct_UFunction_UMocapApp_GetLastErrorStr, "GetLastErrorStr" }, // 1687804372
		{ &Z_Construct_UFunction_UMocapApp_GetRigidBody, "GetRigidBody" }, // 2259346095
		{ &Z_Construct_UFunction_UMocapApp_GetTracker, "GetTracker" }, // 1740826238
		{ &Z_Construct_UFunction_UMocapApp_HasMocapCommandInQueue, "HasMocapCommandInQueue" }, // 2705926073
		{ &Z_Construct_UFunction_UMocapApp_QueueMocapCommand, "QueueMocapCommand" }, // 2286486505
	};
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_MultiplayerOC_Plugins_NeuronLi6ebfd8204a4eV14_Source_NeuronLiveLink_Public_MocapStructs_h_Statics
{
	static constexpr FEnumRegisterCompiledInInfo EnumInfo[] = {
		{ EMCBvhRotationOrder_StaticEnum, TEXT("EMCBvhRotationOrder"), &Z_Registration_Info_UEnum_EMCBvhRotationOrder, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 2690004195U) },
		{ EMCBvhDataFormat_StaticEnum, TEXT("EMCBvhDataFormat"), &Z_Registration_Info_UEnum_EMCBvhDataFormat, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 1776966193U) },
		{ EMCAppProtocol_StaticEnum, TEXT("EMCAppProtocol"), &Z_Registration_Info_UEnum_EMCAppProtocol, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 73375164U) },
		{ EMCUpAxis_StaticEnum, TEXT("EMCUpAxis"), &Z_Registration_Info_UEnum_EMCUpAxis, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 420826613U) },
		{ EMCFrontAxis_StaticEnum, TEXT("EMCFrontAxis"), &Z_Registration_Info_UEnum_EMCFrontAxis, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 2848894647U) },
		{ EMCCoordSystem_StaticEnum, TEXT("EMCCoordSystem"), &Z_Registration_Info_UEnum_EMCCoordSystem, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 1726689408U) },
		{ EMCRotatingDirection_StaticEnum, TEXT("EMCRotatingDirection"), &Z_Registration_Info_UEnum_EMCRotatingDirection, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 2580209811U) },
		{ EMCDistanceUnit_StaticEnum, TEXT("EMCDistanceUnit"), &Z_Registration_Info_UEnum_EMCDistanceUnit, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 1973645584U) },
		{ EMCCommandType_StaticEnum, TEXT("EMCCommandType"), &Z_Registration_Info_UEnum_EMCCommandType, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 21678891U) },
		{ EMCCommandExtraFlag_StaticEnum, TEXT("EMCCommandExtraFlag"), &Z_Registration_Info_UEnum_EMCCommandExtraFlag, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 163406923U) },
	...
	static constexpr FStructRegisterCompiledInInfo ScriptStructInfo[] = {
		{ FMCAppSettings::StaticStruct, Z_Construct_UScriptStruct_FMCAppSettings_Statics::NewStructOps, TEXT("MCAppSettings"), &Z_Registration_Info_UScriptStruct_MCAppSettings, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FMCAppSettings), 3252899386U) },
		{ FMCRenderSetting::StaticStruct, Z_Construct_UScriptStruct_FMCRenderSetting_Statics::NewStructOps, TEXT("MCRenderSetting"), &Z_Registration_Info_UScriptStruct_MCRenderSetting, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FMCRenderSetting), 2367929154U) },
		{ FMocapRigidBody::StaticStruct, Z_Construct_UScriptStruct_FMocapRigidBody_Statics::NewStructOps, TEXT("MocapRigidBody"), &Z_Registration_Info_UScriptStruct_MocapRigidBody, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FMocapRigidBody), 3560166033U) },
		{ FMocapTracker::StaticStruct, Z_Construct_UScriptStruct_FMocapTracker_Statics::NewStructOps, TEXT("MocapTracker"), &Z_Registration_Info_UScriptStruct_MocapTracker, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FMocapTracker), 1899970528U) },
		{ FMocapAvatar::StaticStruct, Z_Construct_UScriptStruct_FMocapAvatar_Statics::NewStructOps, TEXT("MocapAvatar"), &Z_Registration_Info_UScriptStruct_MocapAvatar, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FMocapAvatar), 3921431996U) },
		{ FMocapRecordNotify::StaticStruct, Z_Construct_UScriptStruct_FMocapRecordNotify_Statics::NewStructOps, TEXT("MocapRecordNotify"), &Z_Registration_Info_UScriptStruct_MocapRecordNotify, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FMocapRecordNotify), 2744884068U) },
		{ FMocapServerCommand::StaticStruct, Z_Construct_UScriptStruct_FMocapServerCommand_Statics::NewStructOps, TEXT("MocapServerCommand"), &Z_Registration_Info_UScriptStruct_MocapServerCommand, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FMocapServerCommand), 1165163771U) },
	};
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UMocapApp, UMocapApp::StaticClass, TEXT("UMocapApp"), &Z_Registration_Info_UClass_UMocapApp, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMocapApp), 1469318257U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_MultiplayerOC_Plugins_NeuronLi6ebfd8204a4eV14_Source_NeuronLiveLink_Public_MocapStructs_h_1652123534(TEXT("/Script/NeuronLiveLink"),
	Z_CompiledInDeferFile_FID_MultiplayerOC_Plugins_NeuronLi6ebfd8204a4eV14_Source_NeuronLiveLink_Public_MocapStructs_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_MultiplayerOC_Plugins_NeuronLi6ebfd8204a4eV14_Source_NeuronLiveLink_Public_MocapStructs_h_Statics::ClassInfo),
	Z_CompiledInDeferFile_FID_MultiplayerOC_Plugins_NeuronLi6ebfd8204a4eV14_Source_NeuronLiveLink_Public_MocapStructs_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_MultiplayerOC_Plugins_NeuronLi6ebfd8204a4eV14_Source_NeuronLiveLink_Public_MocapStructs_h_Statics::ScriptStructInfo),
	Z_CompiledInDeferFile_FID_MultiplayerOC_Plugins_NeuronLi6ebfd8204a4eV14_Source_NeuronLiveLink_Public_MocapStructs_h_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_MultiplayerOC_Plugins_NeuronLi6ebfd8204a4eV14_Source_NeuronLiveLink_Public_MocapStructs_h_Statics::EnumInfo));
// End Registration
